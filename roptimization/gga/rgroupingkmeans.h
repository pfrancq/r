...
protected:
	...
	/**
	 * Class representing a "prototype" group generated by the Refine method.
	 * @short Prototype Group
	 */
	...
	public:
		 ...
		 * Construct a group.
		 * @param id         Identifier.
		 * @param max        Initial maximal number of objects contained.
		 */
		 ...
		 *         elements.
		 */
		int Compare(const Group& grp) const {return(Id-grp.Id);}
	};

	/**
	 * Class representing a centroid of a group, including the average
	 * similarity insider the group.
	 * @short Centroid of a group.
	 */
	class Centroid
	{
	public:
		...
		/**
		  * Object being the centroid.
		  */
		cObj* Obj;

		/**
		 * Average similarity with the objects.
		 */
		double AvgSim;
		...
		/**
		 * Compare method with an object used RContainer.
