...
//------------------------------------------------------------------------------
/**
* The RHGAException class provides an exception generated by the HGA.
* @author Pascal Francq
* @short HGA Exception
*/
class RHGAException : public RGAException
{
public:

	/**
	 *  Normal HGA exception.
	 */
	static const RGAException::tException eHGA=RGAException::tException(RGAException::eGA+3);
	...
	*/
	RHGAException(const char* msg,tException type=eHGA) : RGAException(msg,type) {}
};
