...
public:
	...
	*/
	 ...
	 */
	inline bool ContainOnlySpaces(void) const {return(StringMethods::ContainOnlySpaces(Data->Text,Data->Len));}
	...
	*         found.
	*/
	inline int Find(const C car,int pos=0,bool CaseSensitive=true) const {return(StringMethods::Find(Data->Text,Data->Len,car,pos,CaseSensitive));}
	...
	*         found.
	*/
	int FindStr(const S& str,int pos=0,bool CaseSensitive=true) const {return(StringMethods::FindStr(Data->Text,Data->Len,str.Data->Text,str.Data->Len,pos,CaseSensitive));}
	...
	*         found.
	*/
	int FindAnyStr(const S& str,int pos=0,bool CaseSensitive=true) const {return(StringMethods::FindAnyStr(Data->Text,Data->Len,str.Data->Text,str.Data->Len,pos,CaseSensitive));}
   ...
   */
	bool Begins(const S& begin,bool skip=false) const  {return(StringMethods::Begins(Data->Text,Data->Len,begin.Data->Text,begin.Data->Len,skip));}
   ...
   */
	bool Ends(const S& end,bool skip=false) const  {return(StringMethods::Ends(Data->Text,Data->Len,end.Data->Text,end.Data->Len,skip));}
	...
	*/
	 ...
	 */
	bool IsAt(const S& sub,int pos) const  {return(StringMethods::IsAt(Data->Text,Data->Len,sub.Data->Text,sub.Data->Len,pos));}
