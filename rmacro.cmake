...
MACRO(ADD_FRONTEND _frontend_for_target _type _lt_vers _so_vers _vers _libdest _include_dest _includes)
	FOREACH(${_frontend_for_target}_fe ${${_frontend_for_target}_AVAILABLE_FRONTENDS})
		INCLUDE_DIRECTORIES(${${_includes}} ${CMAKE_BINARY_DIR}/${_frontend_for_target})
		IF(${${_frontend_for_target}_fe} STREQUAL "kde")
			KDE4_ADD_LIBRARY(${_frontend_for_target}${${_frontend_for_target}_fe} ${_type} ${${_frontend_for_target}_${${_frontend_for_target}_fe}_TARGET_SOURCES})
		ELSE(${${_frontend_for_target}_fe} STREQUAL "kde")
			ADD_LIBRARY(${_frontend_for_target}${${_frontend_for_target}_fe} ${_type} ${${_frontend_for_target}_${${_frontend_for_target}_fe}_TARGET_SOURCES})
		ENDIF(${${_frontend_for_target}_fe} STREQUAL "kde")
...
ENDMACRO(ADD_FRONTEND _frontend_for_target _type _lt_vers _so_vers _vers _libdest _include_dest _type _includes)
...
MACRO(DO_R_LIB_INCLUDE _libPath)
        ...
        INCLUDE_DIRECTORIES("${_libPath}/rcore/frontend/qt")
        ...
        INCLUDE_DIRECTORIES("${_libPath}/roptimization/frontend/qt")
        ...
        INCLUDE_DIRECTORIES("${_libPath}/roptimization/multicriteria")
		  ...
		  INCLUDE_DIRECTORIES("${_libPath}/rprg/core")
        INCLUDE_DIRECTORIES("${_libPath}/rprg/frontend")
        INCLUDE_DIRECTORIES("${_libPath}/rprg/frontend/qt")

        LINK_DIRECTORIES(${_libPath}/build/rcore)
        LINK_DIRECTORIES(${_libPath}/build/rmath)
        LINK_DIRECTORIES(${_libPath}/build/roptimization)
		  LINK_DIRECTORIES(${_libPath}/build/rprg)
